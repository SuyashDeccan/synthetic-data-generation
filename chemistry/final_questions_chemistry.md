### Question ID: 29b19d56f7ba457192dc268dacf870bd
**Question:**
...
### Question ID: a794999f929d462c8d839d206594a571
**Question:**
...
### Question ID: 1d914e186fcf41db9be357dbb69fa1db
**Question:**
...
### Question ID: 98c270971e16462d9e4799f69987d0d6
**Question:**
...
### Question ID: 7536ebb0a7ff473884c5f27e4218afd8
**Question:**
...
### Question ID: 0bfd3d9faa5a4ce3943d9d6a76084ad9
**Question:**
...
### Question ID: 76ed0f58262849549c211eb3974d3e12
**Question:**
...
### Question ID: a6e114a359a7409395c147ad5e863c46
**Question:**
...
### Question ID: 59c3deb2ab8b426a90436c1a98331c70
**Question:**
...
### Question ID: b7a7f62ecac2437d807071e62b0dec3c
**Question:**
...
### Question ID: 66bf83711244409fb2e0bab66902347e
**Question:**
*E. coli* Central Metabolism Flux Optimization
...
### Question ID: 5a944402e40b4712ad8c751c45455173
**Question:**
Yeast Ethanol Fermentation Thermodynamic Bottleneck
...
### Question ID: 77a3d688ed2d4abca3e3c45c09070d12
**Question:**
Cyanobacterial Photosynthetic Light Saturation Kinetics

A cyanobacterial culture is grown under constant illumination. The rate of photosynthesis increases with light intensity but eventually saturates. The photosynthetic rate is described by the Monod equation: $v = v_{max} \cdot \frac{I}{K_I + I}$, where $v$ is the rate of photosynthesis, $v_{max}$ is the maximum rate, $I$ is light intensity, and $K_I$ is the half-saturation constant. At a light intensity of $I = 50 \ \mu mol \cdot m^{-2} \cdot s^{-1}$, the photosynthetic rate is $80 \%$ of $v_{max}$. Calculate the light intensity (in $\mu mol \cdot m^{-2} \cdot s^{-1}$) required to achieve $95 \%$ of $v_{max}$.

### Question ID: 4926cba6521e4875af1081674650359b
**Question:**
Mammalian Cell Culture ATP Production and Metabolic Flux Analysis
...
### Question ID: 8dd8a227bf354bd09957bdbf7c9ed3d9
**Question:**
Plant Cell Metabolic Trade-off Between Growth and Phenylpropanoid Defense

A plant cell can allocate resources either to biomass (approximated as $(CH_2O)_n$) or to the production of the phenylpropanoid coumaric acid ($C_9H_8O_3$). Assume the cell utilizes $glucose$ ($C_6H_{12}O_6$) as its sole carbon source. Producing $1$ mole of coumaric acid requires $2$ moles of $NADPH$ and $1$ mole of $ATP$. Biomass production is more efficient, requiring only $0.5$ moles of $NADPH$ and $0.25$ moles of $ATP$ per mole of $(CH_2O)_n$. If the cell has a limited supply of $NADPH$ and $ATP$, such that it can only produce a total of $10$ moles of $NADPH$ and $5$ moles of $ATP$ per hour, what is the maximum theoretical yield of biomass (in moles of $(CH_2O)_n$ per hour) if the cell also produces $1$ mole of coumaric acid per hour?

### Question ID: 2521286fa66b456eb39ca74ac1f3b2a8
**Question:**
*E. coli* Central Metabolism Flux Optimization

A chemostat culture of `$E. coli$` is grown on `$glucose$` minimal media. Assume a simplified metabolic network consisting of `$glycolysis$`, the `$PPP$`, and the `$TCA$` cycle. Using stoichiometric modeling, determine the maximum theoretical biomass yield (in `$gDW \cdot mol_{glc}^{-1}$`) if the `$NADPH$` required for biosynthesis is solely supplied by the `$PPP$`, and the `$ATP$` required for biosynthesis is solely produced through oxidative phosphorylation with a `$P/O$` ratio of `$1.5$` (moles `$ATP$` produced per mole of oxygen consumed). Assume the biomass composition corresponds to the empirical formula `$CH_{1.8}O_{0.5}N_{0.2}$`, where `$glucose$` supplies `$50 \%$` of C, `$NH_3$` supplies all N, `$O_2$` supplies `$10 \%$` of O, and `$H_2O$` supplies all H and `$90 \%$` of O.

### Question ID: b93bc2dfa40e43288e161a3ea77a0feb
**Question:**
Yeast Ethanol Fermentation Thermodynamic Bottleneck

A batch fermentation of `$Saccharomyces cerevisiae$` is performed under anaerobic conditions with `$glucose$` as the sole carbon source. The initial `$glucose$` concentration is not standard, and the temperature is maintained at `$30$`°C. The initial concentrations are: `[Glucose]` = `$150$` mM, `[Ethanol]` = `$10$` mM, `[CO2]` = `$1$` mM.  Calculate the Gibbs free energy change (`$\Delta G$`) (in `$kJ/mol$`) for the overall reaction under these non-standard conditions. The standard Gibbs free energies of formation at `$298 \ K$` are: `$Glucose$` (`$-917.2 \ kJ/mol$`), `$Ethanol$` (`$-174.8 \ kJ/mol$`), and `$Carbon Dioxide$` (`$-394.4 \ kJ/mol$`). Assume the reaction proceeds according to the balanced stoichiometric equation: `$C_6H_{12}O_6 \rightarrow 2 \ C_2H_5OH + 2 \ CO_2$`. Use the ideal gas constant `$R = 8.314 \ J \cdot mol^{-1} \cdot K^{-1}$`. *Assume that the standard Gibbs free energies of formation at `$298 \ K$` are valid for the reaction temperature of `$30$`°C.*

### Question ID: 32312f86e4b248d1ad4211dbbe261146
**Question:**
Cyanobacterial Photosynthetic Light Saturation Kinetics

A cyanobacterial culture is grown under constant illumination. The rate of photosynthesis increases with light intensity but eventually saturates. The photosynthetic rate is described by the Monod equation: `$v = v_{max} \cdot \frac{I}{K_I + I}$`, where `$v$` is the rate of photosynthesis, `$v_{max}$` is the maximum rate, `$I$` is light intensity, and `$K_I$` is the half-saturation constant. At a light intensity of `$I = 50 \ \mu mol \cdot m^{-2} \cdot s^{-1}$`, the photosynthetic rate is `$80 \%$` of `$v_{max}$`. Calculate the light intensity (in `$\mu mol \cdot m^{-2} \cdot s^{-1}$`) required to achieve `$95 \%$` of `$v_{max}$`.

### Question ID: 5c998801fc3f4e2888570252c0cbde2b
**Question:**
Mammalian Cell Culture ATP Production and Metabolic Flux Analysis
...
### Question ID: 93082e8c05f348b69c00a6e008531987
**Question:**
Plant Cell Metabolic Trade-off Between Growth and Phenylpropanoid Defense

A plant cell can allocate resources either to biomass (approximated as `$(CH_2O)_n$`) or to the production of the phenylpropanoid coumaric acid (`$C_9H_8O_3$`). Assume the cell utilizes `$glucose$` (`$C_6H_{12}O_6$`) as its sole carbon source. Producing `$1$` mole of coumaric acid requires `$2$` moles of `$NADPH$` and `$1$` mole of `$ATP$`. Biomass production is more efficient, requiring only `$0.5$` moles of `$NADPH$` and `$0.25$` moles of `$ATP$` per mole of `$(CH_2O)_n$`. If the cell has a limited supply of `$NADPH$` and `$ATP$`, such that it can only produce a total of `$10$` moles of `$NADPH$` and `$5$` moles of `$ATP$` per hour, what is the maximum theoretical yield of biomass (in moles of `$(CH_2O)_n$` per hour) if the cell also produces `$1$` mole of coumaric acid per hour?

### Question ID: 6471a174f87147c09b7260085f11fabd
**Question:**
...
### Question ID: 993f79a2d86444abae040e2c46c5547f
**Question:**
...
### Question ID: eafdd8dd7f9a442b848cc388beedf9cb
**Question:**
...
### Question ID: 59c0d8d33120494b9c90f7a770543560
**Question:**
...
### Question ID: 1e5020f0662549f7857fa85f359aff69
**Question:**
...
### Question ID: 1672cb01963746469ca71b075eca0a92
**Question:**
...
### Question ID: 1800e186d1fc49e0996a505e99039171
**Question:**
...
### Question ID: a2f0a4d07944444cb6bf8cceee279a0a
**Question:**
...
### Question ID: 7faba41451b24ae9a5654fb9b72e809c
**Question:**
...
### Question ID: a117c340e02247a78881e2c2495f8f06
**Question:**
...
### Question ID: ca85927044954d3490dc1aa8e4945738
**Question:**
...
### Question ID: 228ec8585d5a48fda494ddb33f25365e
**Question:**
...
### Question ID: 86a41081a98744e6b822fff7b0e7df0b
**Question:**
...
### Question ID: 895e8cb941e244379e84b8afdac3505d
**Question:**
...
### Question ID: cfad59fe04b6458582c4d4e6493ce1b5
**Question:**
...
### Question ID: cb7001ade5be4f12acf3a2e29ad6f475
**Question:**
...
### Question ID: 56cee218cb03458a98d1d803e5a13051
**Question:**
...
### Question ID: 9615e455d6a5471886ea389d48259834
**Question:**
...
### Question ID: 5877cf0db80e4cda9fc3e2aa5174cfa2
**Question:**
...
### Question ID: b5357abc054145c981bd6bb64f5697f0
**Question:**
...
### Question ID: 82155966e94f41788750b93f14011010
**Question:**
...
### Question ID: c3d30d4790624307a886fd62ab651ced
**Question:**
...
### Question ID: 05c28453e13b407d84b5a690b0055d54
**Question:**
...
### Question ID: 8c9e7444327046128603f3da7b9c5d79
**Question:**
...
### Question ID: d2d04bbb4476486eb46459c5fd043a12
**Question:**
...
### Question ID: 8048fb18d47540a0ac551f80d6bd47bc
**Question:**
...
### Question ID: b1b114ade5384f309fab15886c878a16
**Question:**
...
### Question ID: 3690e8d6e2224702a9713426fc902d00
**Question:**
...
### Question ID: 215e7ad19b074dc8bccfc7c05e485196
**Question:**
...
### Question ID: 15939a55bd2e4e90ad059f608215a94e
**Question:**
...
### Question ID: c8cca17582174915a1b89e166a899ef5
**Question:**
...
### Question ID: 58aed90b8c3c430bb7d7874858ae8e49
**Question:**
...
### Question ID: 099ef49dcc024ca591393fa606296597
**Question:**
...
### Question ID: 82fb4768c6d64059b7e073031c0a5d7e
**Question:**
...
### Question ID: 40253720a4d94a10ab0dd813237d5b29
**Question:**
...
### Question ID: ddd660cac1d6447dae8c8c8c1bbe813a
**Question:**
...
### Question ID: e5d7d0d0ca3f4b109fc48964f4a968c7
**Question:**
...
### Question ID: 4def7b0f92db4c7aab6354f63c80a056
**Question:**
...
### Question ID: c2e305d79e8340a9bed2b6ec7578636e
**Question:**
...
### Question ID: 75a675b13ba44136ac59faccf6e404e9
**Question:**
...
### Question ID: 76e4072f1c734473b29539c4d1ddddcf
**Question:**
...
### Question ID: 0f404bb98a8841aaa0ae3315ea9bffc1
**Question:**
...
### Question ID: 0ded0c6770784666a98fe95af2779f2e
**Question:**
...
### Question ID: 5fc7c52ce763405a8ef378e00807c9f9
**Question:**
...
### Question ID: b470d710fdb648beb1078802d627d44b
**Question:**
...
### Question ID: 1d795fc867354e8f9acbe6d15dccc968
**Question:**
...
### Question ID: 2bdbbc3b10454aa5b7704250bf408c1d
**Question:**
...
### Question ID: ca5e45d3075e4e6996e405eb5563dda3
**Question:**
...
### Question ID: c02352a85f7d432e94bff0911dc4b3b3
**Question:**
...
### Question ID: 9016e46bfa5049c786d59534956feea7
**Question:**
...
### Question ID: f3eb1f5134e74c46a7066558f636fb08
**Question:**
...
### Question ID: 5dae3b4ac7d8484a9905da36dc6ab7fa
**Question:**
...
### Question ID: 99623f0b7c1c4945885e1130626466fc
**Question:**
...
### Question ID: 703c5fc6037645c88671026797959ab7
**Question:**
...
### Question ID: a0f855cd5da94a7e96547ac2f9659e96
**Question:**
...
### Question ID: 192359a384ad4f119a63250e1e85de0b
**Question:**
...
### Question ID: c429331867cf496092d2dece61eb25b3
**Question:**
...
### Question ID: d122f3bff0ad4a43882886de5fdd6125
**Question:**
...
### Question ID: 80ad59f19e1b48bfb6b4d8c5a975417c
**Question:**
...
### Question ID: 4f2ab50ad7d64d63b13d1e0f3105f35f
**Question:**
...
### Question ID: 18b0536ccda34a92a1dce3b60d19bd2f
**Question:**
{i+1}. {question}
